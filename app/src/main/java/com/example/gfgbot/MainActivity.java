...
public class MainActivity extends AppCompatActivity {
    ...
    private void getResponse(String userMsg) {
        //below line is to pass message to our array list which is entered by the user.
        messageModalArrayList.add(new MessageModal(userMsg, USER_KEY));
        messageRVAdapter.notifyDataSetChanged();
        //url for our brain
        //make sure to add mshape for uid.
        String url = "http://api.brainshop.ai/get?bid=161120&key=rToFpionzEGRP6tZ&uid=[uid]&msg=" + userMsg;
        ...
        call.enqueue(new Callback<MsgModel>() {
            ...
            public void onResponse(Call<MsgModel> call, retrofit2.Response<MsgModel> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    messageModalArrayList.add(new MessageModal(model.getCnt(), BOT_KEY));
                    messageRVAdapter.notifyDataSetChanged();
                }
            }
            ...
            public void onFailure(Call<MsgModel> call, Throwable t) {
                messageModalArrayList.add(new MessageModal("Hello How can I help You", BOT_KEY));
                messageRVAdapter.notifyDataSetChanged();
